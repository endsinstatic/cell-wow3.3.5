...
-- ProcGlow (disabled on 3.3.5a — requires FlipBook animations & SetAtlas)
if not isRetail then
    -- Provide no-op stubs so callers don't error
    function lib.ProcGlow_Start() end
    function lib.ProcGlow_Stop() end
