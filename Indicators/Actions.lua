...
local function CreateAnimationGroup_TypeA()
    ...
    a1.duration = 0.6
    if a1.SetFromAlpha then a1:SetFromAlpha(0) end
    if a1.SetToAlpha then a1:SetToAlpha(1) end
    a1:SetOrder(1)
    ...
    a2.duration = 0.5
    if a2.SetFromAlpha then a2:SetFromAlpha(1) end
    if a2.SetToAlpha then a2:SetToAlpha(0) end
...
local function CreateAnimationGroup_TypeB()
    ...
    a1.duration = 0.35
    if a1.SetFromAlpha then a1:SetFromAlpha(0) end
    if a1.SetToAlpha then a1:SetToAlpha(0.7) end
    a1:SetDuration(a1.duration)
    -- a1:SetSmoothing("IN")
...
local function CreateAnimationGroup_TypeC()
    ...
    a2:SetDuration(a2.duration)
    a2:SetOrder(2)
    if a2.SetSmoothing then a2:SetSmoothing("IN") end
