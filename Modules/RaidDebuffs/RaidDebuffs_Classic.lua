...
local function CreatePreviewButton()
    ...
    if fadeIn.SetFromAlpha then fadeIn:SetFromAlpha(0) end
    ...
    if fadeOut.SetToAlpha then fadeOut:SetToAlpha(0) end
...
local function CreateNoticeFrame()
    ...
    local noticeFrame = CreateFrame("Frame", nil, debuffsTab)
    ...
    content:SetFont((UNIT_NAME_FONT_CHINESE or GameFontNormal:GetFont()), 12 + CellDB["appearance"]["optionsFontSizeOffset"], "")
