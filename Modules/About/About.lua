...
local function CreateTranslatorsPane()
    ...
    translatorsTextCN.font = (UNIT_NAME_FONT_CHINESE or GameFontNormal:GetFont())
...
local function CreateSpecialThanksPane()
    ...
    specialThanksText.font = (UNIT_NAME_FONT_CHINESE or GameFontNormal:GetFont())
...
local function CreateAnimation(frame)
    ...
    if fadeOut.alpha.SetFromAlpha then fadeOut.alpha:SetFromAlpha(1) end
    if fadeOut.alpha.SetToAlpha then fadeOut.alpha:SetToAlpha(0) end
    ...
    if fadeIn.alpha.SetFromAlpha then fadeIn.alpha:SetFromAlpha(0) end
    if fadeIn.alpha.SetToAlpha then fadeIn.alpha:SetToAlpha(1) end
...
local function CreateSupportersPane()
    ...
    supportersText1.font = (UNIT_NAME_FONT_CHINESE or GameFontNormal:GetFont())
    ...
    supportersText2.font = (UNIT_NAME_FONT_CHINESE or GameFontNormal:GetFont())
