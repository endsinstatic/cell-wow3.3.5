...
local tooltipPoint, tooltipRelativePoint, tooltipX, tooltipY = "TOPLEFT", "BOTTOMLEFT", 0, -3
-------------------------------------------------
-- CellMainFrame
-------------------------------------------------
...
if menuFrame.fadeIn.alpha.SetFromAlpha then menuFrame.fadeIn.alpha:SetFromAlpha(0) end
if menuFrame.fadeIn.alpha.SetToAlpha then menuFrame.fadeIn.alpha:SetToAlpha(1) end
...
if menuFrame.fadeOut.alpha.SetFromAlpha then menuFrame.fadeOut.alpha:SetFromAlpha(1) end
if menuFrame.fadeOut.alpha.SetToAlpha then menuFrame.fadeOut.alpha:SetToAlpha(0) end
menuFrame.fadeOut.alpha:SetDuration(0.5)
if menuFrame.fadeOut.alpha.SetSmoothing then menuFrame.fadeOut.alpha:SetSmoothing("OUT") end
...
local function MainFrame_UpdateLayout(layout, which)
    ...
    if not init then
        ...
        -- NOTE: [petbattle] doesn't exist in 3.3.5a; skip RegisterStateDriver to avoid keyboard taint
        if not Cell.is335 then
