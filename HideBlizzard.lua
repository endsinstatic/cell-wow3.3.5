...
function F.HideBlizzardParty()
    -- 3.3.5a: Blizzard uses PARTY_MEMBERS_CHANGED/RAID_ROSTER_UPDATE, not GROUP_ROSTER_UPDATE
    _G.UIParent:UnregisterEvent("GROUP_ROSTER_UPDATE")
    pcall(function() _G.UIParent:UnregisterEvent("PARTY_MEMBERS_CHANGED") end)
    pcall(function() _G.UIParent:UnregisterEvent("RAID_ROSTER_UPDATE") end)
