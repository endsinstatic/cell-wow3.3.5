...
local function CreateProcessingFrame()
    ...
    processingFrame:SetScript("OnShow", function()
        Cell335_RegisterEvent(processingFrame, "GROUP_ROSTER_UPDATE")
        ProcessNext()
    end)
